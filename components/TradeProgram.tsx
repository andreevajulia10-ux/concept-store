...
export default function TradeProgram() {
  return (
    <section className="relative mx-auto w-full max-w-[1536px]">
      ...
      <div
        className="pointer-events-none absolute inset-0 -left-[72px] w-[1536px] max-sm:left-0 max-sm:w-full"
        style={{
          backgroundImage:
      ...
      <div className="relative flex px-[72px] max-sm:flex-col max-sm:px-4">
        {/* Заголовок слева */}
        ...
        {/* Правая колонка */}
        <div className="flex w-[1119px] flex-col border-t-[0.8px] border-[#4a0a05] py-[80px] pr-[87px] max-sm:w-full max-sm:py-[40px] max-sm:pr-0">
          <div className="flex items-start justify-between max-sm:flex-col max-sm:gap-[32px]">
            <div className="flex flex-col gap-[32px]">
              <p className="w-[633px] whitespace-pre-wrap font-['Questrial'] text-[26px] leading-[31.2px] text-[#4a0a05] max-sm:w-full">
